<template>
    <div>
        ...
        <div v-else class="w-full">
            <div class="overflow-x-auto rounded-3xl border border-brand-100/50 dark:border-navy-700 bg-white/80 dark:bg-navy-800/80 backdrop-blur-xl shadow-lg shadow-brand-500/5">
